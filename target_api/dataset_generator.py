...
class ReMorphFuzzer:
    def __init__(self, spec_path: str | None = None, base_url: str = "http://127.0.0.1:8000"):
        root_dir = Path(__file__).resolve().parent
        self.spec_path = str(Path(spec_path) if spec_path else root_dir / "specs" / "openapi.json")
        self.output_path = root_dir / "training_dataset.json"
    ...
    def run_fuzzer(self, multiplier=1):
        ...
        print(f"📁 Semantic Truth & Delta mapping complete -> {self.output_path}")
